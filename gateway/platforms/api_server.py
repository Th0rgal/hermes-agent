...
class APIServerAdapter(BasePlatformAdapter):
    ...
    async def _handle_create_job(self, request: "web.Request") -> "web.Response":
        ...
        try:
            ...
            # Hermes already persists these as per-job inference overrides;
            # expose them through the authenticated API rather than making a
            # desktop client silently lose an explicit model choice.
