        ...
        try:
            ...
            if direct_path:
                    ...
                    if callable(emit):
                        if total_exhausted:
                            ...
                            emit(
                                ...
                                "dropped — falling back to mechanical tool-output "
                                "elision so the turn can continue. Run /compress "
                                "to retry or /new for a clean session."
                            )
                        else:
                            emit(
                                "⚠ Context compression timed out "
                ...
                def _on_timeout_and_flag(idle, waited, since_progress):
                    ...
                    _on_timeout(idle, waited, since_progress)
