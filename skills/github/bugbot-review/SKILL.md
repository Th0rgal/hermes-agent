---
name: bugbot-review
description: Resolve review threads on open PRs, fix valid issues, reply.
version: 1.0.0
author: thomas
license: MIT
...
metadata:
  hermes:
    tags: [GitHub, Review, PullRequest, Bugbot]
---
...
When asked to address Bugbot or human review findings on a pull request,
clear unresolved review threads, or verify and act on reported issues.
Triggers: bugbot, review issues, bot review, unresolved review threads.
