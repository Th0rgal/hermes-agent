---
name: media-creation
description: Generate images/video via Wan, Gemini/Veo, GPT Image.
version: 1.0.0
author: thomas
license: MIT
platforms: [linux, macos, windows]
prerequisites:
  env_vars: [OPENAI_API_KEY, GOOGLE_GENAI_API_KEY, DASHSCOPE_API_KEY]
  commands: [curl]
metadata:
  hermes:
    tags: [Image, Video, Generation, API]
---
...
When generating images or video via Alibaba Wan (DashScope), Google
Gemini/Veo, or OpenAI GPT Image, or when producing transparent PNGs and
alpha extractions. Triggers: image generation, video generation, wan,
gemini, veo, gpt image, background removal, transparent png.
