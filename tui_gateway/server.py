                ...
                with _session_db(session) as db:
                    if db is not None:
                        ...
                        if _is_gateway_owned_source(source):
                            ...
                            # Project control sessions reclaimed by an idle /
                            # LRU / orphaned-websocket reap stay open: they are
                            # the durable delivery target for project:<slug>
                            # cron routes and are reopened on delivery.
